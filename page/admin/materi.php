                ...
                <table class="table table-striped table-hover align-middle">
                  ...
                  <?php foreach ($materi as $row) : ?>
                    <tr>
                      ...
                      <td><i><a href="<?= $row["link_materi"] ?>">Lihat Materi</a></i></td>
                      <td>
                        <?= substr($row['deskripsi_materi'], 0, 150) . '....' ?></td>
                      <td>
                        <a href="edit/edit-materi.php?id=<?= $row["id_materi"] ?>" type="button" class="btn btn-primary btn-sm">Edit</a>
                        <a href="hapus/hapus-materi.php?id=<?= $row["id_materi"] ?>" type="button" class="btn btn-danger btn-sm">Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </table>

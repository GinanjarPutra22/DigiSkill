            ...
            <div class="accordion-collapse collapse show" id="collapseOne" data-bs-tongle="#accordionSection">
              <div class="accordion-body">
                <div class="d-grid gap-3">
                  ...
                  <a href="materi-uiux-2.php" class="btn btn-primary disabled mb-1">
                    2. Basic Tools (Figma)
                  </a>
        ...
        <div class="collapse show" id="collapse2">
          <div class="card card-body">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-end">
              <a href="materi-uiux-3.php" class="btn btn-primary">Next</a>
            </div>
            ...
            <p></p>
            <p>
              Figma juga merupakan aplikasi desain UI dan UX yang dapat kamu
              gunakan untuk membuat situs web, aplikasi, atau komponen
              antarmuka pengguna.
            </p>
            <p></p>
            <p>
              Dengan arahan website, kali ini kita akan belajar mengenai basic
              tools pada Figma dengan melihat video yang sudah disiapkan.
            </p>
          </div>
        </div>

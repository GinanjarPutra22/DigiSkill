    ...
    <div class="container accordion" id="accordionExample">
        <div class="row my-5">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header mb-2">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            data-bs-target="#materi-1" aria-expanded="true" aria-controls="materi-1">
                            Materi 1
                        </button>
                    </h2>
                    <h2 class="accordion-header mb-2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#materi-2" aria-expanded="false" aria-controls="materi-2">
                            Materi 2
                        </button>
                    </h2>
                    <h2 class="accordion-header mb-2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#materi-3" aria-expanded="false" aria-controls="materi-3">
                            Materi 3
                        </button>
                    </h2>
                    <h2 class="accordion-header mb-2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#materi-4" aria-expanded="false" aria-controls="materi-4">
                            Materi 4
                        </button>
                    </h2>
                    <h2 class="accordion-header mb-2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#materi-5" aria-expanded="false" aria-controls="materi-5">
                            Materi 5
                        </button>
                    </h2>
                </div>
            ...
            <div class="col-lg-9">
                ...
                <!-- Vid Materi 1 -->
                <div id="materi-1" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                ...
                <!-- Vid Materi 2 -->
                <div id="materi-2" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="card card-body">
                            <div class="ratio ratio-16x9">
                                <iframe src="https://www.youtube.com/embed/PJIKqnftfPw" class="" allowfullscreen>
                                </iframe>
                            </div>

                            <div class="2. Basic Tools (Figma) py-3"></div>
                            <div class="d-grid gap-5 d-md-flex justify-content-arround">
                                <h2 class="fs-7">2. Basic Tools (Figma)</h2>
                            </div>
                            <div class="d-grid gap-2 d-md-flex justify-content-end">
                                <a href="#" type="button" class="btn btn-primary" data-bs-toggle="collapse"
                                    data-bs-target="#materi-3" aria-expanded="false" aria-controls="materi-3">Next</a>
                            </div>

                            <p>Apa saja basic tools yang ada pada Figma?</p>
                            <p></p>
                            <p>
                                Figma adalah aplikasi desain berbasis cloud dan alat prototyping
                                untuk project digital. Figma dapat membantu para penggunanya
                                berkolaborasi dalam suatu project atau pekerjaan dengan banyak
                                pengguna secara real-time dan di mana saja.
                            </p>
                ...
                <!-- Vid Materi 3 -->
                <div id="materi-3" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="">
                            <div class="ratio ratio-16x9">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-end">
                                <a href="#" type="button" class="btn btn-primary" data-bs-toggle="collapse"
                                    data-bs-target="#materi-4" aria-expanded="false" aria-controls="materi-4">Next</a>
                            </div>
                ...
                <!-- Vid Materi 4 -->
                <div id="materi-4" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/41_zU4pheWg" class="" allowfullscreen>
                            </iframe>
                        </div>

                        <div class="4. Layouting (Figma) py-3"></div>
                        <div class="d-grid gap-5 d-md-flex justify-content-arround">
                            <h2 class="fs-7">4. Layouting (Figma)</h2>
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-end">
                            <a href="#" type="button" class="btn btn-primary" data-bs-toggle="collapse"
                                data-bs-target="#materi-5" aria-expanded="false" aria-controls="materi-5">Next</a>
                        </div>

                        <p>Apa itu Layouting Figma?</p>
                        <p></p>
                        <p>
                            Layout merupakan desain tata letak, sedangkan arti dari layout
                            adalah suatu susunan, rancangan, atau tata letak ruang dari
                            sebuah elemen yang sengaja didesain untuk bisa ditempatkan dalam
                            suatu bidang yang sebelumnya telah direncanakan sistemnya
                            terlebih dahulu.
                        </p>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Tugas"
                                data-bs-whatever="@mdo">Kirim Tugas</button>
                        </div>

...
<head>
    ...
    <title>DigiSkill-Materi-Backend</title>
                    ...
                    <div class="accordion-item mb-3">
                        <h1 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapseOne">Materi Video Kelas Back-End Development</button>
                        </h1>
                        <div class="accordion-collapse collapse show" id="collapseOne"
                            ...
                            <div class="accordion-body">
                                <div class="d-grid gap-3">
                                    ...
                                    <a href="materi-backend-3.php" class="btn btn-primary  disabled mb-1">

                                        3. Laravel
                                    </a>
                                    <a href="materi-backend-4.php" class="btn btn-primary  mb-1">
                ...
                <div class="collapse show" id="collapse1">
                    <div class="card card-body ">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/ClMX6TXvh_o" class="" allowfullscreen>
                            </iframe>
                        </div>


                        <div class="3. Laravel py-3"></div>
                        <div class="d-grid gap-5 d-md-flex justify-content-arround">
                            <h2 class="fs-7">3. Laravel</h2>
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-end">
                            <a href="materi-backend-4.php" class="btn btn-primary">Next</a>
                        </div>

                        <p>Apa itu Laravel?</p>
                        <p></p>
                        <p>Laravel adalah framework berbasis bahasa pemrograman PHP yang bisa digunakan untuk membantu
                            proses pengembangan sebuah website agar lebih maksimal. Dengan menggunakan Laravel, website
                            yang dihasilkan akan lebih dinamis.</p>
                        <p></p>
                        <p>Kehadiran framework Laravel menjadikan bahasa pemrograman PHP menjadi lebih powerful. Perlu
                            kita ketahui bahwa kehadiran framework Laravel selalu menghadirkan fitur-fitur terbaru
                            dibandingkan framework lainnya.</p>
                        <p></p>
                        <p>Dengan arahan website, kali ini kita akan belajar mengenai Laravel pada Back-End Development
                            dengan melihat video yang sudah disiapkan.</p>
                    </div>
                </div>

                ...
                <div class="collapse show" id="collapse1">
                    <div class="card card-body ">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/9ed3b0tSRvI" class="" allowfullscreen>
                            </iframe>
                        </div>


                        <div class="4. Rest API py-3"></div>
                        ...
                        <p></p>
                        <p>API adalah sekumpulan aturan atau kode yang menghubungkan dua program atau lebih untuk
                            berkomunikasi, API menjadi penghubung antar aplikasi / website dalam satu platform maupun
                            lintas platform. Salah satu API Protokol yang sering digunakan yaitu REST API adalah
                            arsitektur / pendekatan komunikasi API yang bersifat stateless dan menggunakan HTTP/HTTPS
                            dalam transmisi data.</p>
                        <p></p>
                        <p>Dengan arahan website, kali ini kita akan belajar mengenai Rest API pada Back-End Development

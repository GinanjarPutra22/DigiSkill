                        ...
                        <div class="accordion-collapse collapse show" id="collapseOne"
                            ...
                            <div class="accordion-body">
                                <div class="d-grid gap-3">
                                    ...
                                    <a href="materi-backend-5.php" class="btn btn-primary disabled mb-1">
                ...
                <div class="collapse show" id="collapse1">
                    <div class="card card-body ">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/b39Xqf5iyjo" class="" allowfullscreen>
                            </iframe>
                        </div>


                        <div class="5. NodeJS py-3"></div>
                        <div class="d-grid gap-5 d-md-flex justify-content-arround">
                            <h2 class="fs-7">5. NodeJS</h2>
                        </div>

                        <p>Apa itu NodeJS?</p>
                        <p></p>
                        <p>Node.js adalah runtime environment untuk JavaScript yang bersifat open-source dan
                            cross-platform. Dengan Node.js kita dapat menjalankan kode JavaScript di mana pun, tidak
                            hanya terbatas pada lingkungan browser.</p>
                        <p></p>
                        <p>Node.js menjalankan V8 JavaScript engine (yang juga merupakan inti dari Google Chrome) di
                            luar browser. Ini memungkinkan Node.js memiliki performa yang tinggi.</p>
                        <p></p>
                        <p>Node.js juga menyediakan banyak library/module JavaScript yang membantu menyederhanakan
                            pengembangan aplikasi web.</p>
                        <p></p>
                        <p>Dengan arahan website, kali ini kita akan belajar mengenai NodeJS pada Back-End Development

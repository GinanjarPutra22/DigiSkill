                        ...
                        <div class="accordion-collapse collapse show" id="collapseOne"
                            ...
                            <div class="accordion-body">
                                <div class="d-grid gap-3">
                                    ...
                                    <a href="materi-backend-2.php" class="btn btn-primary  disabled mb-1">
                ...
                <div class="collapse show" id="collapse1">
                    <div class="card card-body ">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/lTMZxWMjXQU" class="" allowfullscreen>
                            </iframe>
                        </div>


                        <div class="2. Git dan GitHub py-3"></div>
                        <div class="d-grid gap-5 d-md-flex justify-content-arround">
                            <h2 class="fs-7">2. Git dan GitHub</h2>
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-end">
                            <a href="materi-backend-3.php" class="btn btn-primary">Next</a>
                        </div>

                        <p>Apa itu Git dan GitHub?</p>
                        <p></p>
                        <p>Git dan GitHub merupakan dua platform yang didirikan oleh satu perusahaan dengan tujuan sama
                            serta fitur yang berbeda. Namun kedua platform ini sangat membantu pekerjaan programmer
                            dalam menyusun kode script secara tim. Seluruh pekerjaan juga dapat dipantau dan dievaluasi
                            dengan mudah karena penggunaan kontrol sistem.</p>
                        <p></p>
                        <p>Dengan arahan website, kali ini kita akan belajar mengenai Git dan GitHub pada Back-End
                            Development dengan melihat video yang sudah disiapkan.</p>
                    </div>
                </div>

                        ...
                        <div class="accordion-collapse collapse show" id="collapseOne"
                            ...
                            <div class="accordion-body">
                                <div class="d-grid gap-3">
                                    ...
                                    <a href="materi-backend-1.php" class="btn btn-primary disabled mb-1">
                ...
                <div class="collapse show" id="collapse1">
                    <div class="card card-body ">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/TaBWhb5SPfc" class="" allowfullscreen>
                            </iframe>
                        </div>


                        <div class="1. PHP py-3"></div>
                        <div class="d-grid gap-5 d-md-flex justify-content-arround">
                            <h2 class="fs-7">1. PHP</h2>
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-end">
                            <a href="materi-backend-2.php" class="btn btn-primary">Next</a>
                        </div>

                        <p>Apa itu PHP?</p>
                        <p></p>
                        <p>PHP adalah singkatan dari Hypertext Preprocessor, yaitu bahasa penulisan skrip yang
                            sebenarnya mirip dengan JavaScript dan Python.</p>
                        <p></p>
                        <p>Perbedaannya, PHP adalah bahasa yang biasanya digunakan untuk komunikasi sisi server,
                            sedangkan JavaScript bisa digunakan untuk frontend dan backend. Sementara itu, Python hanya
                            untuk sisi server (backend).</p>
                        <p></p>
                        <p>Dengan arahan website, kali ini kita akan belajar mengenai PHP pada Back-End Development
